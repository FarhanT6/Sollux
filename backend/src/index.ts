...
import payPlanRouter from './routes/payPlan';
import messageDraftsRouter from './routes/messageDrafts';
...
app.use('/api/pay-plan', payPlanRouter);
app.use('/api/message-drafts', messageDraftsRouter);
